...
func NewShift(distance int) Cipher {
	// +/- 26 would return no encoding because the (English) alphabet loops at 26.
...
// shiftParser shifts all letters by shift number of characters. Non-letters are ignored.
func shiftParser(r rune, c shift) rune {
...
// (c shift) Encode encodes each letter with a shift cipher, c character so the right.
/// Non-letters are ignored.
func (c shift) Encode(input string) string {
	return strings.Map(func(r rune) rune { return shiftParser(r, c) }, input)
}
